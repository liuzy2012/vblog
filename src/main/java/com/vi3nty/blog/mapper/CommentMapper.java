...
public interface CommentMapper extends BaseMapper<Comment> {
    ...
    @Select("select c.id as id,c.content as content,c.comm_email as comm_email,a.id as aid,a.title as art_title from comment c LEFT JOIN article a on c.aid=a.id where a.id=#{aid}")
    IPage<CommentVo> getCommentByAid(IPage iPage,@Param("aid") int aid);
}
